...
class MobileOceanWebImpl(
    ...
    override suspend fun createArticle(
        ...
        appendClubParam: ArticleAppendClubParam?,
        appendParam: ArticleAppendParam?
    ): Result<CreateArticleResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun replyArticle(
        ...
        isUseClubToReply: Boolean,
        image: File?
    ): Result<ReplyArticleResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
            val builder = MultipartBody.Builder().setType(MultipartBody.FORM)
            builder.apply {
    ...
    override suspend fun getRepliedArticleIds(
        articleIds: List<Long>
    ): Result<RepliedArticleIds> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getStockArticleList(
        ...
        replyFetchSize: Int,
        isIncludeLimitedAskArticle: Boolean
    ): Result<GetStockArticleListResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getReplyArticleList(
        articleId: Long
    ): Result<GetReplyArticleListResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getForumLatestArticles(
        ...
        fetchCount: Int,
        IsIncludeLimitedAskArticle: Boolean
    ): Result<GetForumLatestArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getForumPopularArticles(
        ...
        fetchCount: Int,
        IsIncludeLimitedAskArticle: Boolean
    ): Result<GetForumPopularArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getStockLatestArticles(
        ...
        fetchCount: Int,
        IsIncludeLimitedAskArticle: Boolean
    ): Result<GetStockLatestArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getStockPopularArticles(
        ...
        fetchCount: Int,
        IsIncludeLimitedAskArticle: Boolean
    ): Result<GetStockPopularArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getChannelLatestArticles(
        ...
        baseArticleId: Long,
        fetchCount: Int
    ): Result<GetChannelLatestArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getChannelPopularArticles(
        ...
        fetchCount: Int,
        isIncludeLimitedAskArticle : Boolean
    ): Result<GetChannelPopularArticlesResponse> = withContext(ioDispatcher)  {
        kotlin.runCatching {
    ...
    override suspend fun getFollowedChannelArticles(
        ...
        fetchCount: Int,
        isIncludeLimitedAskArticle: Boolean
    ): Result<GetFollowedChannelArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getPopularQuestionArticles(
        ...
        skipCount: Int,
        fetchCount: Int
    ): Result<GetPopularQuestionArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getLatestQuestionArticles(
        ...
        skipCount: Int,
        fetchCount: Int
    ): Result<GetLatestQuestionArticlesResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun likeArticle(
        articleId: Long
    ): Result<LikeArticleResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
            service.likeArticle(
                authorization = setting.accessToken.createAuthorizationBearer(),
                appId = setting.appId,
    ...
    override suspend fun addInterestedInArticleInfo(
        articleId: Long,
        points: Int
    ): Result<AddInterestedInArticleInfoResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getAskStockTendencyAmount(
        stockId: String
    ): Result<AskStockTendencyAmountResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getArticleTips(
        ...
        fetchCount: Int,
        skipCount: Int
    ): Result<GetArticleTipsResponse> = withContext(ioDispatcher){
        kotlin.runCatching {
    ...
    override suspend fun getFansChannel(
        ...
        skipCount: Int,
        fetchCount: Int
    ): Result<GetFansChannelResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getAttentionChannel(
        ...
        skipCount: Int,
        fetchCount: Int
    ): Result<GetAttentionChannelResponse> = getAttentionChannel(channelId, needInfo, skipCount, fetchCount)
    ...
    override suspend fun getAttentionChannel(
        ...
        skipCount: Int,
        fetchCount: Int
    ): Result<GetAttentionChannelResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
    ...
    override suspend fun getStockPicture(
        stockId: String,
        type: PictureType
    ): Result<GetStockPictureResponse> = withContext(ioDispatcher){
        kotlin.runCatching {
    ...
    override suspend fun activeFollow(): Result<ActiveFollowResponse> = withContext(ioDispatcher) {
        kotlin.runCatching {
