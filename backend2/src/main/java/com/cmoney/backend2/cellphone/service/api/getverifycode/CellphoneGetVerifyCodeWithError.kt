 ...
 */
data class CellphoneGetVerifyCodeWithError(
    /**
     * 驗證碼有效時間(秒)
     */
    ...
    IWithError<CellphoneGetVerifyCode> {

    override fun toRealResponse(): CellphoneGetVerifyCode {
        return CellphoneGetVerifyCode(
            verifyCodeDuration, verifyCodeResendInterval
        )
    }
}