...
class AdditionalInformationRevisitTwWebImplTest {
    ...
    fun setUp() {
        ...
        coEvery {
            manager.getAdditionInformationRevisitTwSettingAdapter().getDomain()
        } returns EXCEPT_DOMAIN
        coEvery {
            manager.getAdditionInformationRevisitTwSettingAdapter().getPathName()
