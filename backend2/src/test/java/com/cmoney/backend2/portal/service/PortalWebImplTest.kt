...
class PortalWebImplTest {
    ...
    @Test
    fun `getTarget_response code is 1_成功`() = mainCoroutineRule.runTest {
    ...
    @Test
    fun `getTarget_response code is 100_參數錯誤`() = mainCoroutineRule.runTest {
    ...
    @Test
    fun `getTarget_response code is 101_身分驗證錯誤`() = mainCoroutineRule.runTest {
        val responseBodyJson = """
    ...
    @Test
    fun `getSignals_response code is 1_成功`() = mainCoroutineRule.runTest {
    ...
    @Test
    fun `getSignals_response code is 100_參數錯誤`() = mainCoroutineRule.runTest {
        val responseBodyJson = """
            {"Error":{"Code":100,"Message":"參數錯誤"}}
        """.trimIndent()
    ...
    @Test
    fun `getSignals_response code is 101_身分驗證錯誤`() = mainCoroutineRule.runTest {
        val responseBodyJson = """
            {"Error":{"Code":101,"Message":"身分驗證錯誤"}} 
        """.trimIndent()
        val responseBody = gson.fromJson<CmPortalSignalWithError>(
    ...
    @Test
    fun `getAdditionalInfo_response code is 1_成功`() = mainCoroutineRule.runTest {
    ...
    @Test
    fun `getAdditionalInfo_response code is 100_參數錯誤`() = mainCoroutineRule.runTest {
        val responseBodyJson = """
            {"Error":{"Code":100,"Message":"參數錯誤"}}
        """.trimIndent()
    ...
    @Test
    fun `getAdditionalInfo_response code is 101_身分驗證錯誤`() = mainCoroutineRule.runTest {
        val responseBodyJson = """
            {"Error":{"Code":101,"Message":"身分驗證錯誤"}} 
        """.trimIndent()
        val responseBody = gson.fromJson<CmPortalAdditionWithError>(
