...
class DtnoWebImplTest {
    ...
    @Test
    fun `getKLineData_成功`() = mainCoroutineRule.runBlockingTest {
    ...
    @Test
    fun `getKLineData_參數錯誤`() = mainCoroutineRule.runBlockingTest {
        val response = DtnoWithError(
            listOf("日期", "開盤價", "最高價", "最低價", "收盤價", "成交量", "漲跌", "漲幅(%)", "成交金額(千)"),
            listOf()
        )
    ...
    @Test
    fun `getLatestBasicInfo_成功`() = mainCoroutineRule.runBlockingTest {
    ...
    @Test
    fun `getLatestBasicInfo_參數錯誤`() = mainCoroutineRule.runBlockingTest {
    ...
    @Test
    fun `getLatestBasicInfo_身分驗證錯誤`() = mainCoroutineRule.runBlockingTest {
        val responseBodyJson = """
