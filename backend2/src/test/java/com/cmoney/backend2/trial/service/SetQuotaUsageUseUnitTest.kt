...
class SetQuotaUsageUseUnitTest {
    ...
    fun setQuotaUsageUse_TimeoutException() = mainCoroutineRule.runTest {
        coEvery {
    ...
    @Test
    fun `setQuotaUsageUse_失敗_無效的金鑰`() = mainCoroutineRule.runTest {
    ...
    @Test
    fun `setQuotaUsageUse_成功_hasTrialAuth為true`() = mainCoroutineRule.runTest {
        val responseBody =
    ...
    @Test
    fun `setQuotaUsageUse_成功_hasTrialAuth為false`() = mainCoroutineRule.runTest {
        val responseBody =
            SetQuotaUseResponseBody(
                false
            )
