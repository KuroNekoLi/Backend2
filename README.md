...
dependecies {
	implementation 'com.cmoney.backend2:backend2:4.5.0'
...
```groovy
dependecies {
	releaseImplementation 'com.cmoney.backend2:backend2:4.5.0'
	debugImplementation 'com.cmoney.backend2:backend2-debug:4.5.0'
	implementation("com.cmoney.logdatarecorder:logdatarecorder-data:1.1.0")
	implementation("com.cmoney.logdatarecorder:logdatarecorder-domain:1.1.0")
}
```
