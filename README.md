...
dependecies {
	implementation 'com.cmoney.backend2:backend2:4.5.1'
...
```groovy
dependecies {
	releaseImplementation 'com.cmoney.backend2:backend2:4.5.1'
	debugImplementation 'com.cmoney.backend2:backend2-debug:4.5.1'
	implementation("com.cmoney.logdatarecorder:logdatarecorder-data:1.1.0")
	implementation("com.cmoney.logdatarecorder:logdatarecorder-domain:1.1.0")
}
```
